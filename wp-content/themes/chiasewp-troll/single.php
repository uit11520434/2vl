...
<div id="content">
    <div id="mainContainer">
        <div id="leftColumn">
            <div class="box photoDetails">
                ...
                <div class="likeButton fixedScroll">
                    ...
                    <div class="navButtons">
                        <?php if (!empty($prevID)) { ?>
                        <a class="prev" href="<?php echo get_permalink($prevID); ?>" title="<?php echo get_the_title($prevID); ?>">Ảnh trước</a>
                        <?php } if (!empty($nextID)) { ?>
                        <a class="next" href="<?php echo get_permalink($nextID); ?>" title="<?php echo get_the_title($nextID); ?>">Ảnh sau</a>
                        <?php } ?>
                    </div><!-- .navigation -->
                ...
                <div class="photoImg">
                    ...
                    <iframe width="100%" height="365" src="//www.youtube.com/embed/<?php echo youtube_id(get_post_meta($post->ID, 'youtube_url', true)) ;?>" frameborder="0" allowfullscreen></iframe>
                    <?php } else { ?>
                    <img src="<?php echo get_img_post(); ?>" alt="<?php the_title(); ?>" />
                    <?php } ?>
                </div>
                ...
                <div>
                    <div id='div-gpt-ad-1346990951948-0' style='width: 655px; height: 150px; display: none; margin-top: 10px'>
            ...
            <div id="footer">
                <ul class="left">Power by <a href="http://chiasewp.com" target="_blank">chiaseWP.com</a></ul>
